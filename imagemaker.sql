...
('CBR02','Clean Beauty(Reserve)','Skin','100','辛香調','佛手柑','橙花','金銀花','香草','蘭花','牡丹','麝香','白雪松','','2940','週末','約會','專業','中性香','裸露性感，令人耳目一新，體驗溫暖的擁抱帶來的振奮感。'),
...
('CBR07','Clean Beauty(Reserve)','Sueded Oud','100','辛香調','多香果','金銀花','藍柏','茉莉','小荳蔻','玉蘭','琥珀','麝香','','2940','專業','週末','約會','男香','強烈回味，毫不動搖的大膽，透過純粹而頹廢以追求美。'),
...
INSERT INTO `product_list`(`product_num`, `brand`, `product_name`, `ml`, `frangrance`, `top_note1`, `top_note2`, `top_note3`, `middle_note1`, `middle_note2`, `middle_note3`, `base_note1`, `base_note2`, `base_note3`, `price`, `situation_1`, `situation_2`, `situation_3`, `gender`, `caption`) 
VALUES
('','CBA04','Clean Beauty(Avant Garden)','Galbanum & Rain','100','','','','','','','','','','','','','','','','','','',),
('','','','','','','','','','','','','','','','','','','','','','','',),
('','','','','','','','','','','','','','','','','','','','','','','',),
('','','','','','','','','','','','','','','','','','','','','','','',),
('','','','','','','','','','','','','','','','','','','','','','','',),
