 ...
 <footer class="footer">
            ...
            <nav class="navbar ">
                ...
                <ul class="contact font-white mobile-none">
                    ...
                    <li class="contact-item"><a href="mailto:ImageMaker@gmail.com">E-mail : ImageMaker@gmail.com</a>
                    </li>
                    <li class="contact-item">Copyright © 2020 Image Maker </li>
                </ul> 
            </nav>
            <!-- Start 手機隱藏footer -->
            <div class="flex-column justify-content-center popup-footer desktop-none">
                ...
                <ul class=" flex-column text-center contact font-white">
                    <li class="contact-item"><a href="tel:+886987654321">Tel : 0987654321</a></li>
                    <li class="contact-item"><a href="mailto:ImageMaker@gmail.com">E-mail : ImageMaker@gmail.com</a>
                    </li>
                    <li class="contact-item">Copyright © 2020 Image Maker </li>
                </ul>
